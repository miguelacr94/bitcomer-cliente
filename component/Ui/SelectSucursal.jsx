    ...
    return (
        <div className="relative w-full lg:cursor-pointer outline-none" >
            <div id={id} className="mt-3">
                ...
                <div id={id} onClick={() => setShow(true)} className={`${className} ${errors ? 'border-red-300' : 'border-grey-bInput'} rounded-full p-2 pl-4 h-11  border border-grey-bInput flex justify-center items-center mt-1`}>
                    {icon &&
                        <img
                            className="w-4 h-4"
                            src={icon}
                    ...
                    <p
                        id={id}
                        className="pl-1 ml-1 mt-1 w-full outline-none bg-transparent placeholder:text-xs placeholder:text-grey text-md  text-grey font-light"
                    >{value && capitalizer(value)}</p>
                            ...
                            return (
                                ...
                                <div onClick={() => onChange(e)} key={i} className="hover:bg-Option rounded-md cursor-pointer  w-full flex justify-start items-center px-2"  >
                                    ...
                                    >
                                        ...
                                        <p className="mt-1">{e && capitalizer(e.name)}- {e && capitalizer(e?.city)}</p>
                                    </a>
                                </div>
